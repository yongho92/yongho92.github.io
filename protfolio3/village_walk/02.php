	...
	<div class="contents">
		...
		<div class="cous_board">
			<div class="board_ser03">
				<span class="board_all3" id="boa_set3_text">다정한 청춘길</span>
				<label for="boa_set3" class="sor_hide3">다정한 청춘길</label>
				<select id="boa_set3" name="tmp_searchCnd2" onchange="cnd_box2();">
				<option value="02.php" selected>다정한 청춘길</option>
		...
		<div class="sub_cont">
			...
			<div class="rec_cou">
				<div class="cou_list">
					<ul>
						<li><a href="02.php" class="on">다정한 청춘길</a></li>
			...
			<div class="map">
				...
				<div class="map_img cou_map_img">
					<div class="map_movimg">
						<img src="../web/images/sub/village_walk/cous01_img.jpg" alt="달콤한 청춘길 코스 이미지" class="web_img"/>
						<img src="../web/images/sub/village_walk/cous01_img_m.jpg" alt="달콤한 청춘길 코스 이미지" class="mob_img"/>
						<a href="http://www.balsanvillage.com/web/images/sub/village_walk/cous01_img.jpg" target="_blank"  class="map_ex"><img src="../web/images/sub/village_walk/map_ex.jpg" alt="지도확대"/></a>
					</div>
					<div class="map_list">
						<h3>다정한 청춘길<span>알콩달콩 달달하게 공방체험 및 카페투어</span></h3>
						<ul class="web_list2">
							<li seq="1" class="marx"><a href="#"><em>1</em><span>청춘빌리지 1호<strong>(할매공방카페)</strong></span></a></li>
							<li seq="2" class="green"><a href="#"><em>2</em><span>아우라 팩토리<strong>(아트전시장)</strong></span></a></li>
							<li seq="3" class="green"><a href="#"><em>3</em><span>청춘빌리지2<strong>(다경이의 식탁)</strong></span></a></li>
							<li seq="4" class="padx"><a href="#"><em>4</em><span>108계단<strong>(포토존)</strong></span></a></li>
							<li seq="5" class="padx green"><a href="#"><em>5</em><span>표류<strong>(아트샵&amp;카페)</strong></span></a></li>
							<li seq="6" class="marx last_box"><a href="#"><em>6</em><span>뽕뽕브릿지<strong>(레지던시)</strong></span></a></li>
						</ul>
<!-- 						<div class="moblie_list">
							<ul>
								<li><a href="#" class="on"><span>1</span><strong>청춘빌리지 1호 (할매공방카페)</strong></a></li>
								<li><a href="#"><span>2</span><strong>아우라 팩토리 (아트전시장)</strong></a></li>
								<li><a href="#"><span>3</span><strong>청춘빌리지2 (다경이의 식탁)</strong></a></li>
								<li><a href="#"><span>4</span><strong>108계단 (포토존)</strong></a></li>
								<li><a href="#"><span>5</span><strong>표류 (아트샵&amp;카페)</strong></a></li>
								<li class="last_box"><a href="#"><span>6</span><strong>뽕뽕브릿지 (레지던시)</strong></a></li>
							</ul>
						</div> -->
					</div>
				</div>
