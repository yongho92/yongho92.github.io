...
<%
    ...
    parameters.setDefault("sc_board_seq", 3);
...
function submitPage(page){
    ...
    frm.submitForm3(window, "sub03.jsp");
}
...
function fw_domReady(){
    ...
    $(".btnView").click(function(e){
        ...
        frm.submitForm3(window, "sub03_view.jsp");
        return false;
    });
        ...
        $("#btnList").click();
			...
			<div class="sub_cont">
				<div class="pr_cont">
					<div class="pr_tab">
						<ul>
							<li class=""><a href="sub02.jsp" class="mob_on">브로슈어</a></li>
							<li class="mob_tab on"><a href="sub03.jsp">카달로그</a></li>
							<li class="barx mob_tab"><a href="sub04.jsp">홍보영상</a></li>
						</ul>
						<ul class="mob_tab_box">
							<li class="on"><a href="javascript:void(0);" class="mob_on">카달로그</a></li>
							<li class="mob_tab"><a href="../news/sub04.jsp">홍보영상</a></li>
							<li class="barx mob_tab"><a href="../news/sub02.jsp">브로슈어</a></li>
						</ul>
					</div>
					<div class="pr_list catalog">
<%
...
%>
					...
					<div class="view">
						<p>* PDF파일을 보시려면 Adobe Acrobat Reader를 설치하셔야 합니다.<button type="button" onclick="window.open('https://get.adobe.com/kr/reader/');" onfocus="this.blur();">뷰어 다운로드</button></p>
