...
<%
    ...
    parameters.setDefault("sc_category_text", "1990");
				...
				<div class="his_cont">
					...
					<div class="his_tab ">
						<ul>
							...
							<li class="bgx"><a href="../company/sub06.jsp" class="on">1990's</a></li>
						</ul>
						<ul class="mob_tab_box">
							<li class="mob_tab on"><a href="javascript:void(0);" class="mob_on">1990년대</a></li>
                    ...
                    <div class="his_list">
						<p class="tit"><span>1990's</span></p>
