...
<%
    ...
    if(parameters.isEqual("act", "preview")){
		sql.setLength(0);
        sql.append("select * from ENG_POPUP where seq='" + parameters.print("sc_seq") + "' ");
...
function fw_domReady(){
    ...
    $(".popup_metadata").each(function(){
        ...
        if(arr[4] == "Y") {
            ...
            openPopup("eng_popup.jsp?seq=" + arr[0], "popup_" + arr[0], arr[2], arr[3], arr[1]);

        }
        else openPopup2("eng_popup.jsp?seq=" + arr[0], "popup_" + arr[0], arr[2], arr[3], arr[5], arr[6], arr[1]);
