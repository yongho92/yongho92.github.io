...
<%
    ...
    DataEntity popDE = popMgr.getPopup(seq);
...
<table border="0" cellpadding="0" cellspacing="10" style="background:#1f2430; width:610px;">
	<tr>
        <td align="right"><a href="javascript:closePopup('halla_popup<%=popDE.print("seq")%>');"><img src="http://hrd.halla.com/web/images/common/popup_btn_close.jpg" alt="닫기" border="0" align="right" /></a><% if(popDE.isEqual("cookie_yn", "Y")){ %><a href="javascript:checkChk('halla_popup<%=popDE.print("seq")%>');" name="chk"><img src="http://hrd.halla.com/web/images/common/popup_btn_close1.jpg" alt="1일간 팝업 열지 않기" border="0" align="right" /></a><% } %></td>
    </tr>
</table>
</div>
</span>
