...
<!-- 						<p>유라코퍼레이션과 협력사는 함께 지속 가능한 성장을 위해 아름다운 동행을 실천하고 있습니다. </p>
						...
						<p>유라코퍼레이션과 협력사는 함께 지속 가능한 성장을 위해 아름다운 동행을 실천하고 있습니다. </span></p>
						<div class="join_movlist">
							<div class="join_movimg">
								...
								<dl>
									<dt>우리모두를 위한 변화</dt>
									<dd>우리 모두를 위한 변화가 새로운 미래를 위한 <span>동반성장으로 이어진다.</span></dd>
								</dl>
							...
							<div class="join_movimg join_movimg2">
								...
								<dl>
									<dt>상생협력 이제는 희망</dt>
									<dd>혁신의 자원을 교감하는 생태계와 같이 신뢰를 바탕으로 <span>수평적협업 확대 필요</span></dd>
								</dl>
