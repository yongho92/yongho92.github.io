						...
						<div class="re_cont">
							<div class="not_view">
								<table>
									...
									<tbody>
										<tr>
											<td class="box1"><p class="title"><span class="view_txt01"><?=$singleDE01["category_text"]?></span> <?=$singleDE01["title"]?></p></td>
											<td class="box2">모집기간 : <?=replace($singleDE01["tmp_field2"], "-", ".")?>~<?=replace($singleDE01["tmp_field3"], "-", ".")?></td>
											<td class="box3">
...
<?
    ...
    if($singleDE01["tmp_field3"] >= $now && $singleDE01["tmp_field2"] <= $now)
    {
        $ccStr = "0";
    }

    if($singleDE01["tmp_field2"] > $now)
    {
        $ccStr = "3";
    }
?>
...
<?
        ...
        {
?>
                                            <span class="view_icon">채용마감</span>
<?
        }
        elseif($ccStr == "3")
        {
?>
                                            <span class="view_icon">채용예정</span>
<?
        }
?>
