					...
					<div class="copm1_box">
						...
						<div class="mb_tab">
							<ul>
								...
								<li class="on"><a href="sub4.php">부품 및 A/S</a></li>
								<li><a href="sub5.php">기타(중고차 매매 등)</a></li>
							</ul>
						</div>
						<div class="mb_cont">
							<div class="mb_img">
								<p><img src="../web/images/sub/mb_img04.jpg" alt=""/></p>
							</div>
							<div class="mb_l">
								<p class="mb_icon04"><span>부품 및 A/S</span></p>
							</div>
							<div class="mb_r">
								<ul>
									<li>· 자동차 및 오토바이의 부품 및 악세서리 판매</li>
									<li>· 자동차 및 오토바이 A/S서비스 및 정비 용역 제공</li>
								</ul>
							</div>
						</div>
					</div>
