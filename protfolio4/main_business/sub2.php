					...
					<div class="copm1_box">
						...
						<div class="mb_tab">
							<ul>
								...
								<li class="on"><a href="sub2.php">자동차 생산 및 조립</a></li>
						...
						<div class="mb_cont">
							<div class="mb_img">
								<p><img src="../web/images/sub/mb_img02.jpg" alt=""/></p>
							</div>
							<div class="mb_l">
								<p class="mb_icon02"><span>자동차 생산 및 조립</span></p>
							</div>
							<div class="mb_r">
								<ul>
									<li>· 자체브랜드 DAEHAN의 독자적 R&D, 생산, 판매 및 해외수출</li>
									<li>· 경쟁력 있는 품질의 제품을 합리적 가격 제공</li>
								</ul>
							</div>
						</div>
					</div>
