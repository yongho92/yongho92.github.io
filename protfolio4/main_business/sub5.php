					...
					<div class="copm1_box">
						...
						<div class="mb_tab">
							<ul>
								...
								<li class="on"><a href="sub5.php">기타(중고차 매매 등)</a></li>
							</ul>
						</div>
						<div class="mb_cont">
							<div class="mb_img">
								<p><img src="../web/images/sub/mb_img05.jpg" alt=""/></p>
							</div>
							<div class="mb_l">
								<p class="mb_icon05"><span>기타(중고차 매매 등)</span></p>
							</div>
							<div class="mb_r">
								<ul>
									<li>· 라오스 최초의 전문 중고차 거래 서비스 제공</li>
									<li>· 렌탈 서비스</li>
								</ul>
							</div>
						</div>
