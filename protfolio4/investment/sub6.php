				...
				<div class="cont_box">
					<div class="copm1_box">
						...
						<div class="news_box">
							<div class="ir_tab">
								<ul>
									<li class="on"><a href="sub6.php">IR안내</a></li>
									<li><a href="sub7.php">경영보고서</a></li>
								</ul>
							</div>
							<div class="news_ser">
...
?>
										<tr>
											...
											<td><a href="javascript:;" onclick="goView('<?=$row["seq"]?>', '<?=$num?>');"><?=$row["title"]?></a></td>
											<td class="down">

<?
	if(strlen($photo["seq"]) > 0)
	{

?>


<a href="<?=$webRoot?>common/bulletin_download.php?seq=<?=$photo["seq"]?>" class="on">DOWNLOAD</a>
